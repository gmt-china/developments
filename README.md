...
- 2016-03-20: [@seisman][seisman] 使用 [DNSPod][DNSPod] 作为 DNS 服务器，并设置 A 记录指向 GitHub
- 2016-03-20: [@seisman][seisman] 从 [GoDaddy][GoDaddy] 购买社区域名 [gmt-china.org](http://gmt-china.org)，使用期限一年，价格 ￥55.14
